import { formatHoursOrMinutesOrSeconds } from '../utils/utils'
...
describe('format Hour|Minutes|Seconds should', () => {
  test('add a 0 if the seconds is less than 10', () => {
    ...
    const seconds = formatHoursOrMinutesOrSeconds(new Date().getSeconds())
  ...
  test('add a 0 if the minute is less than 10', () => {
    ...
    const minutes = formatHoursOrMinutesOrSeconds(new Date().getMinutes())
